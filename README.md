...
**Code Snippets**
- [Code Institute](https://codeinstitute.net/) - Inspiration for HERO image taken from the mini project 'Whiskey project' in User Centric Frontend Development.
- [Code Institute](https://codeinstitute.net/) - Inspiration for contact form taken from the mini project 'Resume project' in User Centric Frontend Development.
- [Bootstrap](https://getbootstrap.com/) - Bootstrap code snippets has been used for navigation menu bar, and cards content container for sole purpose of achiving responsiveness behaviour of the website through out all the screen sizes such as mobile, tablet and large screens.     
